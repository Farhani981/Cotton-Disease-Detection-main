...
**AI-Powered Cotton Plant Disease Detection using Deep Learning (ResNet-50)**
...
*   **ResNet-50 Model**: High-accuracy deep learning architecture for image classification.
...
*   **AI/ML**: TensorFlow, Keras, ResNet-50, OpenCV
